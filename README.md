...
- `global-context/` (tracked runtime source of truth shared by Codex / Claude / Gemini)
...
# install once, then sync to Codex + Gemini + CodeBuddy
...
- custom combos such as `claude+codex`, `claude+gemini+codebuddy`, `claude+qwen`
...
# Copy Codex user skills into Claude/Gemini/CodeBuddy
...
## Three-Agent Runtime Sync

Use the tracked repo source of truth when you want skills, global context, and MCP to stay aligned across Codex / Claude / Gemini:
